...
<body>
  ...
  <div class="container-fluid">
    ...
    <a style="color:#d9534f" class="navbar-text navbar-center text-light">Estado Ordenes de Detención</a>
    </nav>
</div>
...
<div class="container ">
    ...
    <form id="formres" name="formres" method="post" action="ingresaordendet2.php">
