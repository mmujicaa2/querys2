...
<body>
  ...
  <table width="29%" border="0" align="center">
    <tr>
      <th scope="col"><strong>Contra Órdenes  vigentes</strong></th>
    </tr>
  </table>
  <hr />
...
<table width="149" border="0">
  <tr>
    <td width="143"><a href="ingresaordendet2.php" target="_self">Ver ordenes vigentes</a></td>
  </tr>
</table>
...
$querypass= "
SELECT DISTINCT RIT.IDF_ROLUNICO,
                RIT.IDF_ROLINTERNO,
                RIT.FEC_ERA,
  ...
  FROM    (   (   (   JUDPENAL.TGES_ORDEN TGES_ORDEN
                   ...
                   ON (TGES_ORDEN.CRR_PARTICIPANTE =
                          TATP_PARTICIPANTE.CRR_IDPARTICIPANTE))
               INNER JOIN
                  JUDPENAL.TGES_ORDENROL TGES_ORDENROL
...
ORDER BY TGES_ORDENROL.FEC_SISTEMA DESC
