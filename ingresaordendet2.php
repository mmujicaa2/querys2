...
<html>
<head>
  <title>Ordenes de Ordenes de Detención </title>
...
<body>
 ...
 <div class="container-fluid text-center">
    <nav class="navbar navbar-nav  navbar-expand-lg bg-secondary">
   	 <a style="color:#d9534f" class="center navbar-text navbar-center text-light">Estado de Ordenes de Detención</a>
   </nav>

 </div>

 <div class="container text-center">
	 <p class="text-dark form-group"><strong><a class="container" href="xlsorden.php?finicioev=<?php echo trim(strtoupper($_POST['finicioev']));?>
