...
<table width="1100" height="57" border="1">
  <tr>
    <td width="848" class="clase91"><strong class="verdana11"><span class="verdana12">Documentos X RIT</span></strong></td>
  </tr>
  <tr>
    <td><form id="anioxdoc" name="anioxdoc" method="post" action="docxrit.php">
      <span class="clase91"> RIT:
        <input name="ritxdoc" type="text" id="ritxdoc" size="5" />
        A&ntilde;o
        <input name="anio2" type="text" id="anio2" size="6" />
        <input type="submit" name="Enviar14" id="Enviar14" value="Submit" />
        </span>
    </form></td>
  </tr>
</table>
...
<input name="codtrib" type="text" id="codtrib" value="953" size="5" maxlength="5" />
</span>Tipo:
  ...
  <tr>
    <td><form id="formimputado2" name="formimputado2" method="post" action="impdelito2.php">
      ...
      RUT:
        ...
        Cod.tribunal <span class="clase91">
        <input name="codtrib2" type="text" id="codtrib2" value="953" size="5" maxlength="5" />
        </span>
